	...
	<div id="container">
		...
		<div class="ui_content">
			<table  cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
				<tr><td><input id="id" type="hidden" value="${ editSelectById.id}"/></td></tr>
				<tr>
					<td class="ui_text_rt" width="80">用户名</td>
					<td class="ui_text_lt">
						<input autocomplete="off" value="${editSelectById.username}" class="ui_input_txt01" id="username" type="text" name="username" placeholder="请输入用户名">
					</td>
				</tr>
				<tr>
					<td class="ui_text_rt">密码</td>
					<td class="ui_text_lt">
						<input autocomplete="off" value="${editSelectById.password}" class="ui_input_txt01" id="password" type="text" name="password" placeholder="请输入密码">
					</td>
				</tr>
				<tr>
					<td class="ui_text_rt">年龄</td>
					<td class="ui_text_lt">
						<input autocomplete="off" value="${editSelectById.age}" class="ui_input_txt01" id="age" type="text" name="age" placeholder = "请输入年龄"/>岁
					</td>
				</tr>
				<tr>
					<td class="ui_text_rt">性别</td>
					<td class="ui_text_lt">
						<input autocomplete="off" value="${editSelectById.sex}" class="ui_input_txt01" id="sex" type="text" name="sex"  placeholder="请输入性别"  "/>
					</td>
				</tr>
				<tr>
					<td class="ui_text_rt">家庭住址</td>
					<td class="ui_text_lt">
						<input autocomplete="off" value="${editSelectById.address}" class="ui_input_txt01" id="address" type="text" name="address" placeholder="请输入家庭住址"/>
					</td>
				</tr>
				<tr>
					<td>&nbsp;</td>
