	...
	<div id="container">
		...
		<div class="ui_content">
			<table  cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
				<tr><td><input id="id" name="id" type="hidden" value="${editSelectNutritionById.id}"/></td></tr>
				<tr>
					<td class="ui_text_rt" width="80">营养名</td>
					<td class="ui_text_lt">
						<input value="${editSelectNutritionById.name }"  autocomplete="off" class="ui_input_txt01" id="name" type="text" name="name" placeholder="请输入话题名">
					</td>
				</tr>
				<tr>
					...
					<td class="ui_text_lt">
						...
						${editSelectNutritionById.description}
						</textarea>
					</td>
				</tr>
				<tr>
