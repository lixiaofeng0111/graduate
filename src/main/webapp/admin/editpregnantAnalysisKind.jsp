	...
	<div id="container">
		...
		<div class="ui_content">
			<table  cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
				<tr><td><input id="id" name="id" type="hidden" value="${editSelectKindById.id}"/></td></tr>
				<tr>
					<td class="ui_text_rt" width="80">类别</td>
					<td class="ui_text_lt">
						<input value="${editSelectKindById.kind}"  autocomplete="off" class="ui_input_txt01" id="kind" type="text" name="kind" placeholder="请输入话题名">
					</td>
				</tr>
				<tr>
					<td>&nbsp;</td>
					<td class="ui_text_lt">
						&nbsp;<input style = "margin-top:30px;" id="analysiskind_btn" type="submit" value="提交" class="ui_input_btn01"/>
...
<script type="text/javascript">
		$(function() {
			$("#analysiskind_btn").click(function() {
