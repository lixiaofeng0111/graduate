		...
		$(function() {
			$("#addnf_btn").click(function() {
				...
				if (name1_val == null || name1_val == "") {
					art.dialog({icon:'error', title:'友情提示', drag:false, resize:false, content:'营养名不能为空！', ok:true,});
				} else if (description1_val == null || description1_val == "") {
					art.dialog({icon:'error', title:'友情提示', drag:false, resize:false, content:'营养描述不能为空！', ok:true,});
				}
