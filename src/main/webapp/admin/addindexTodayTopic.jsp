		...
		<div class="ui_content">
			<table  cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
				...
				<tr>
					...
					<td class="ui_text_lt">
						<textarea style = "height:150px" height="50px" autocomplete="off" class="ui_input_txt01" id="topicContent"  name="topicContent" placeholder = "请输入话题内容"></textarea>
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td>&nbsp;</td>
					<td class="ui_text_lt">
						&nbsp;<input style = "margin-top:30px;" id="addTodayTopic_btn" type="submit" value="提交" class="ui_input_btn01"/>
...
<script type="text/javascript">
		$(function() {
			$("#addTodayTopic_btn").click(function() {
