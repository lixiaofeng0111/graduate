...
<div class="container" style="padding: 30px 0px 0px 110px;">
	...
	<div class="row clearfix">
		<div class="col-md-12 column">
			<table class="table">
				<tbody>
				<c:forEach items="${selectProfessorToptic}" var="selectProfessorToptic">
					<tr >
						<td>
							<a href = "/pageProfessorTopic1?id=${selectProfessorToptic.id}">${selectProfessorToptic.name}</a>
						</td>
						<td>
							${selectProfessorToptic.datetime}
						</td>
					</tr>
				</c:forEach>
				</tbody>
