...
<div class="container" style="padding: 30px 0px 0px 110px;">
	<div style="width: 1000px; height:500px; padding: 20px 0px 0px 50px; border: 1px solid #C5C1AA">
		<div style = "text-align:center;">
			<h2>${selectTopic.name}</h2>
			<h3>${selectTopic.datetime}</h3>
			<hr>
		</div>
		<div>
			<pre>${selectTopic.content }"</pre>
		</div>
	</div>
</div>
